        ...
        Public Sub New()
            ...
            For i As Integer = 0 To 3
                ...
                For i1 As Integer = 0 To 2
                    Dim apt As New Appointment(AppointmentType.Normal, Date.Today.AddDays(i).AddHours(i + 0), Date.Today.AddDays(i).AddHours(i + 1), String.Format("Appointment {0} {1}", i, i1))
                    apt.ResourceId = r.Id
